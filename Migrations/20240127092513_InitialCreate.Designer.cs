...
namespace MoviePlatform.Migrations
{
    ...
    [Migration("20240127092513_InitialCreate")]
            ...
            modelBuilder.Entity("MoviePlatform.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            IdDirector = 2,
                            IdWriter = 1,
                            ImageUrl = "images/DoctorStrange.jpg",
            ...
            modelBuilder.Entity("MoviePlatform.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdReview = 1,
                            CreationDate = new DateTime(2024, 1, 27, 9, 25, 12, 926, DateTimeKind.Utc).AddTicks(2242),
                            Grade = 5,
                            IdMovie = 2,
                            IdUser = 1,
                        ...
                        {
                            IdReview = 2,
                            CreationDate = new DateTime(2024, 1, 27, 9, 25, 12, 926, DateTimeKind.Utc).AddTicks(2244),
                            Grade = 3,
                            IdMovie = 2,
                            IdUser = 2,
                            Text = "A bit boring."
                        ...
                        {
                            IdReview = 3,
                            CreationDate = new DateTime(2024, 1, 27, 9, 25, 12, 926, DateTimeKind.Utc).AddTicks(2245),
                            Grade = 5,
                            IdMovie = 2,
                            IdUser = 3,
                            Text = "Impressive."
                        ...
                        {
                            IdReview = 4,
                            CreationDate = new DateTime(2024, 1, 27, 9, 25, 12, 926, DateTimeKind.Utc).AddTicks(2246),
                            Grade = 4,
                            IdMovie = 2,
                            IdUser = 4,
                            Text = "Nice graphics."
