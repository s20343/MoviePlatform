...
namespace MoviePlatform.Migrations
{
    ...
    [Migration("20240127105713_UpdateImage")]
            ...
            modelBuilder.Entity("MoviePlatform.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdReview = 1,
                            CreationDate = new DateTime(2024, 1, 27, 10, 57, 13, 407, DateTimeKind.Utc).AddTicks(330),
                            Grade = 5,
                            IdMovie = 2,
                            IdUser = 1,
                        ...
                        {
                            IdReview = 2,
                            CreationDate = new DateTime(2024, 1, 27, 10, 57, 13, 407, DateTimeKind.Utc).AddTicks(331),
                            Grade = 3,
                            IdMovie = 2,
                            IdUser = 2,
                            Text = "A bit boring."
                        ...
                        {
                            IdReview = 3,
                            CreationDate = new DateTime(2024, 1, 27, 10, 57, 13, 407, DateTimeKind.Utc).AddTicks(332),
                            Grade = 5,
                            IdMovie = 2,
                            IdUser = 3,
                            Text = "Impressive."
                        ...
                        {
                            IdReview = 4,
                            CreationDate = new DateTime(2024, 1, 27, 10, 57, 13, 407, DateTimeKind.Utc).AddTicks(333),
                            Grade = 4,
                            IdMovie = 2,
                            IdUser = 4,
                            Text = "Nice graphics."
