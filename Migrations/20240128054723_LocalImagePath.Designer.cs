...
namespace MoviePlatform.Migrations
{
    ...
    [Migration("20240128054723_LocalImagePath")]
    partial class LocalImagePath
    {
            ...
            modelBuilder.Entity("MoviePlatform.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IdDirector = 3,
                            IdWriter = 3,
                            ImageUrl = "C:\\Users\\ACER\\Pictures\\Titanic.jpg",
                            Title = "Titanic"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("MoviePlatform.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdReview = 1,
                            CreationDate = new DateTime(2024, 1, 28, 5, 47, 23, 128, DateTimeKind.Utc).AddTicks(1299),
                            Grade = 5,
                            IdMovie = 2,
                            IdUser = 1,
                        ...
                        {
                            IdReview = 2,
                            CreationDate = new DateTime(2024, 1, 28, 5, 47, 23, 128, DateTimeKind.Utc).AddTicks(1300),
                            Grade = 3,
                            IdMovie = 2,
                            IdUser = 2,
                            Text = "A bit boring."
                        ...
                        {
                            IdReview = 3,
                            CreationDate = new DateTime(2024, 1, 28, 5, 47, 23, 128, DateTimeKind.Utc).AddTicks(1302),
                            Grade = 5,
                            IdMovie = 2,
                            IdUser = 3,
                            Text = "Impressive."
