...
namespace MoviePlatform.Migrations
{
    ...
    [Migration("20240128055022_YourMigrationName")]
            ...
            modelBuilder.Entity("MoviePlatform.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdReview = 1,
                            CreationDate = new DateTime(2024, 1, 28, 5, 50, 22, 149, DateTimeKind.Utc).AddTicks(3434),
                            Grade = 5,
                            IdMovie = 2,
                            IdUser = 1,
                        ...
                        {
                            IdReview = 2,
                            CreationDate = new DateTime(2024, 1, 28, 5, 50, 22, 149, DateTimeKind.Utc).AddTicks(3436),
                            Grade = 3,
                            IdMovie = 2,
                            IdUser = 2,
                            Text = "A bit boring."
                        ...
                        {
                            IdReview = 3,
                            CreationDate = new DateTime(2024, 1, 28, 5, 50, 22, 149, DateTimeKind.Utc).AddTicks(3437),
                            Grade = 5,
                            IdMovie = 2,
                            IdUser = 3,
                            Text = "Impressive."
                        ...
                        {
                            IdReview = 4,
                            CreationDate = new DateTime(2024, 1, 28, 5, 50, 22, 149, DateTimeKind.Utc).AddTicks(3438),
                            Grade = 4,
                            IdMovie = 2,
                            IdUser = 4,
                            Text = "Nice graphics."
